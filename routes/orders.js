...
router.put('/:id', requireRole('super_admin', 'admin', 'operation', 'concierge'), ctrl.update);
router.patch('/:id/status', requireRole('super_admin', 'admin', 'operation', 'procurement', 'inventory', 'logistics', 'concierge'), ctrl.updateStatus);
router.delete('/:id', requireRole('super_admin', 'admin', 'concierge'), ctrl.remove);

// Workflow
router.put('/:id/assign', requireRole('super_admin', 'admin', 'manager', 'operation', 'concierge'), ctrl.assignToStage);
